...
use rusty_engine::prelude::bevy::asset::io::memory::Value::Vec;
use rusty_engine::prelude::KeyCode::Key0;
use rand::prelude::*;
...
fn main() {
    ...
    health_message.translation = Vec2::new(550.0,300.0);
